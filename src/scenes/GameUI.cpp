...
inline static ConfigVar<float> cfg_GameUI_EndRankTopNumColorR{"Game.UI.EndRank.Top", "TopNumColorR", 1.0f, "ゲームUI: EndRank上位数値色R"};
inline static ConfigVar<float> cfg_GameUI_EndRankTopNumColorG{"Game.UI.EndRank.Top", "TopNumColorG", 1.0f, "ゲームUI: EndRank上位数値色G"};
inline static ConfigVar<float> cfg_GameUI_EndRankTopNumColorB{"Game.UI.EndRank.Top", "TopNumColorB", 1.0f, "ゲームUI: EndRank上位数値色B"};
